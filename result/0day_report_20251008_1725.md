...
Redis在其内存数据库软件中披露了最大程度安全漏洞的详细信息，该漏洞可能会在某些情况下导致远程代码执行。
该漏洞已被指定为CVE-2025-49844（又名Redishell）。

## Microsoft链接Storm-1175，以利用部署Medusa勒索软件
...
CVSS得分9.8 <a href =“ https://nvd.nist.gov/cvss.cfm？calculator＆version = 3.0&vector = = = vector = av：n/ac：l/pr：n/ui:n/s：n/s:u/c:h/i：h/i:h/a：h/a：h/a:h：h”>彼得·吉尔努斯（@gothburz）和布兰登·尼姆（Brandon Niem）发现的脆弱性...
...
CVSS得分9.8 <a href =“ https://nvd.nist.gov/cvss.cfm？calculator＆version = 3.0&vector = = = vector = av：n/ac：l/pr：n/ui:n/s：n/s:u/c:h/i：h/i:h/a：h/a：h/a:h：h”>趋势研究的彼得·吉尔努斯（@gothburz）发现的脆弱性...
...
A CVSS score 5.3 <a href="https://nvd.nist.gov/cvss.cfm?calculator&version=3.0&vector=AV:N/AC:H/PR:L/UI:N/S:U/C:H/I:N/A:N">AV:N/AC:H/PR:L/UI:N/S:U/C:H/I:N/A:N</a> 严重性 vulnerability discovered by 'Xavier DANEST - Decathlon' was reported t...
...
美国网络安全和基础设施安全局 (CISA) 周一在其已知利用漏洞 (KEV) 目录中添加了一个影响 Linux 和类 Unix 操作系统的 Sudo 命令行实用程序的严重安全漏洞，并援引 e...
...
CVSS 分数 8.2 <a href="https://nvd.nist.gov/cvss.cfm?calculator&version=3.0&vector=AV:L/AC:L/PR:H/UI:N/S:C/C:H/I:H/A:H">AV:L/AC:L/PR:H/UI:N/S:C/C:H/I:H/A:H</a> 严重性 由“VMBreakers（GANGMIN KIM、SANGBIN KIM、Un3x...
...
CVSS 分数 6.0 <a href="https://nvd.nist.gov/cvss.cfm?calculator&version=3.0&vector=AV:L/AC:L/PR:H/UI:N/S:C/C:H/I:N/A:N">AV:L/AC:L/PR:H/UI:N/S:C/C:H/I:N/A:N</a> 严重性 由“VMBreakers（GANGMIN KIM、SANGBIN KIM、Un3x...
...
CVSS 分数 7.8 <a href="https://nvd.nist.gov/cvss.cfm?calculator&version=3.0&vector=AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H">AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H</a> 严重性 由“Peter Girnus (@gothburz) 和 Brandon Niem 发现的漏洞...
...
CVSS得分9.8 <a href =“ https://nvd.nist.gov/cvss.cfm？calculator＆version = 3.0&vector = = = vector = av：n/ac：l/pr：n/ui:n/s：n/s:u/c:h/i：h/i:h/a：h/a：h/a:h：h”>彼得·吉尔努斯（@gothburz）发现的脆弱性，布兰登·尼姆奇...
