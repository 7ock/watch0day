...
微软透露，主动利用SharePoint缺陷背后的威胁参与者之一是在目标系统上部署术士勒索软件。
...
Windows Banking Trojan称为土狼，已成为第一个利用Windows可访问性框架UI Automation（UIA）来收获敏感信息的已知恶意软件应变。
“新的土狼变体针对巴西用户，...
